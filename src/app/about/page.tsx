        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-16 md:py-20">
          ...
          <Reveal delay={0.1}>
            <p className="mt-4 max-w-3xl text-base text-base-content/70">
              ...
              gouvernance claire, des audits réguliers et un suivi d&apos;impact
              accessible pour garantir la confiance des donateurs et la
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-16 md:py-20">
          ...
          <Stagger from="down" className="mt-8 grid gap-6 md:grid-cols-4">
            {[
              ...
              <div key={name} className="card bg-base-100 shadow">
                <div className="card-body">
